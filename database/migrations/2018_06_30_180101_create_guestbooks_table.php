...
class CreateGuestbooksTable extends Migration
{
    ...
    public function up()
    {
        Module::generate("Guestbooks", 'guestbooks', 'nama', 'fa-cube', [
            ["nama", "Nama", "Name", false, "John Doi", 5, 50, true],
            ["email", "Email", "Email", false, "youraliases@domain.com", 5, 80, true],
            ["pesan", "Pesan", "Textarea", false, "isi pesan disini", 0, 0, false],
        ]);
