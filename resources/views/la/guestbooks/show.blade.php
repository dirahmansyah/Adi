...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $guestbook->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Guestbooks", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/guestbooks/'.$guestbook->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Guestbooks", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.guestbooks.destroy', $guestbook->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/guestbooks') }}" data-toggle="tooltip" data-placement="right" title="Back to Guestbooks"><i class="fa fa-chevron-left"></i></a></li>
